        ...
        <div className="navbar">
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              {" "}
              {/* Search bar hidden for small devices */}
              <label className="flex items-center gap-2">
                <input
                  type="text"
                  className="px-3 py-2 border rounded-md grow outline-none dark:bg-slate-900 dark:text-white"
                  placeholder="Search"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            { authUser ? <Logout/> :
           <div>
              <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={() => document.querySelector("#my_modal_3").showModal()}>
                Login
              </a>
              <Login />
      </div>  }
